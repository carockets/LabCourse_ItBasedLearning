...
###Lektion 0 -- 'print'
####Einführung
Um Dinge auf dem Bildschirm ausgeben zu lassen verwendet man den Befehl ‘print’. Um “Hello World” auf der Konsole auszugeben scheiben wir einfach:
...
|--- |--- | --- |
|Die Schüler lernen wie sich Texte im Programm ausgeben lassen| Gib deinen Namen ein und lasse ihn auf dem Bildschrim ausgeben |5 min|
